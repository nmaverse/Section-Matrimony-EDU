  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-24 pb-16 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 text-center flex flex-col items-center">
        ...
        <h1 className="font-display text-5xl md:text-7xl lg:text-8xl font-medium tracking-tight text-white max-w-5xl leading-[1.05] mb-6 animate-fade-in">
        ...
        {/* Tagline using Jost */}
        <p className="font-sans text-lg md:text-xl text-neutral-400 max-w-2xl font-light mb-10 leading-relaxed">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-6 md:gap-12 py-8 px-6 md:px-12 rounded-2xl border border-rose-gold/10 bg-[#121216]/60 backdrop-blur-sm max-w-3xl w-full">
          <div className="flex flex-col items-center">
            <span className="font-display text-4xl font-bold text-white tracking-tight flex items-baseline gap-1">
              {activeRequestsCount}
              <span className="text-xl text-rose-gold font-sans font-normal">+</span>
            </span>
            <span className="text-xs uppercase tracking-widest text-neutral-400 mt-1 font-medium flex items-center gap-1.5 justify-center">
