    ...
    <footer className="bg-[#08080a] border-t border-rose-gold/15 pt-16 pb-12 overflow-hidden relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-12 pb-12 border-b border-rose-gold/10">
            ...
            <ul className="space-y-2 text-xs text-neutral-400">
              ...
              <li className="flex items-center gap-1.5">
                ...
                <a
                  ...
                  className="hover:text-white transition-colors inline-flex items-center gap-1"
                >
                  EDU Website <ExternalLink className="w-2.5 h-2.5" />
                </a>
              </li>
              <li className="flex items-center gap-1.5">
                <Globe className="w-3.5 h-3.5 text-neutral-500" />
                <a
                  href="https://www.facebook.com/eastdeltauniversity/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:text-white transition-colors inline-flex items-center gap-1"
                >
                  EDU Official FB <ExternalLink className="w-2.5 h-2.5" />
                </a>
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="text-[11px] text-neutral-500 space-y-1 font-light leading-relaxed">
              ...
              <p>School of Science, Engineering & Technology</p>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-neutral-500">
          <p>© 2026 Section Matrimony — East Delta University. All rights reserved.</p>
